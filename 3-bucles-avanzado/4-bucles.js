...
let frases = Math.random() > 0.5 ? ['unite', 'states', 'america'] : ['aeropuertos', 'Españoles', 'Navegación', 'Aérea']

console.log('El array frase es: ', frases);
// Aquí tu código
let acronimo = '';
for (let frase of frases) {
    acronimo += frase.charAt(0).toUpperCase();
}
